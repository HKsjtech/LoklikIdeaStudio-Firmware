...
public:
    static void init();
    static void initZAxis();
    static void loop();   
    static bool zAxisHoming(uint8_t client);
    static bool zAxisHoming1(uint8_t client);
    ...
    static void runTest_Rectangle(uint8_t client);
    static bool loadMate(uint8_t client);
    static bool unLoadMate(uint8_t client);
    static bool resetAxis(uint8_t client,bool homing,bool reset,bool tocenter);
