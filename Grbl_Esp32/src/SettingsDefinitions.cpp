...
StringSetting* sj_product_name;
StringSetting* sj_serial_number;
StringSetting* sj_compen_point_set;
IntSetting* sj_bt_rate;
FloatSetting* sj_cfg_l_chn_x_offset;
FloatSetting* sj_cfg_l_chn_y_offset;
FloatSetting* sj_cfg_r_chn_x_offset;
FloatSetting* sj_cfg_r_chn_y_offset;
FloatSetting* sj_cfg_sps_x_offset;
FloatSetting* sj_cfg_sps_y_offset;
FloatSetting* sj_cfg_y_mate_dist;
FloatSetting* sj_cfg_x_pulloff_dist;
FloatSetting* sj_cfg_z_offset;
FloatSetting* sj_cfg_x_offset;
FloatSetting* sj_cfg_x_compens;
FloatSetting* sj_cfg_y_offset;
FloatSetting* sj_cfg_y_compens;
IntSetting* sj_cfg_mate_load_speed; 
FloatSetting* sj_cfg_x_compens_11[11];
FloatSetting* sj_cfg_y_compens_11[11];
FloatSetting* sj_cfg_x_offset_11[11];
FloatSetting* sj_cfg_y_offset_11[11];
...
void make_settings() {
    ...
    sj_product_name = new StringSetting(EXTENDED, WG, NULL, "SJConfig/ProductName", DEFAULT_PRODUCT_NAME);
    sj_serial_number = new StringSetting(EXTENDED, WG, NULL, "SJConfig/SN", DEFAULT_SERIAL_NUMBER);
    sj_bt_rate = new IntSetting(EXTENDED, WG, NULL, "SJConfig/BTRATE", DEFAULT_BT_RATE,0,1); 

    sj_cfg_l_chn_x_offset = new FloatSetting(GRBL, WG, NULL, "SJConfig/LeftPenOffset_X", 4,0,100);
    sj_cfg_l_chn_y_offset = new FloatSetting(GRBL, WG, NULL, "SJConfig/LeftPenOffset_Y", 1,0,100);
    sj_cfg_r_chn_x_offset= new FloatSetting(GRBL, WG, NULL, "SJConfig/RightPenOffset_X", -4.8,0,100);
    sj_cfg_r_chn_y_offset= new FloatSetting(GRBL, WG, NULL, "SJConfig/RightPenOffset_Y", 1,0,100);
    sj_cfg_sps_x_offset  = new FloatSetting(GRBL, WG, NULL, "SJConfig/SPSOffset_X", 14,0,100);
    sj_cfg_sps_y_offset  = new FloatSetting(GRBL, WG, NULL, "SJConfig/SPSOffset_Y", 34.26,0,100);
    sj_cfg_y_mate_dist  = new FloatSetting(GRBL, WG, NULL, "SJConfig/MateDist", -30,-100,100);
    sj_cfg_x_pulloff_dist  = new FloatSetting(GRBL, WG, NULL, "SJConfig/XPulloffDist", 150,0,330); //机器偏移
    sj_cfg_z_offset = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Z", 0,-20,20);
    sj_cfg_x_offset = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X", DEFAULT_X_OFFSET,DEFAULT_X_OFFSET-5.0,DEFAULT_X_OFFSET+5.0);
    sj_cfg_x_compens = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X", 0,-6,6);
    sj_cfg_y_offset = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y", DEFAULT_Y_OFFSET,DEFAULT_Y_OFFSET-5.0,DEFAULT_Y_OFFSET+5.0);
    sj_cfg_y_compens = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y", 0,-6,6);
    sj_cfg_mate_load_speed = new IntSetting(GRBL, WG, NULL, "SJConfig/MateLoadSpeed", 3000,500,9000);

    sj_compen_point_set = new StringSetting(EXTENDED, WG, NULL, "SJConfig/PointSet", DEFAULT_COMPEN_POINT_SET);

    sj_cfg_x_offset_11[0] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X0", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[0] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X0", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[0] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y0", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[0] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y0", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[1] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X1", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[1] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X1", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[1] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y1", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[1] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y1", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[2] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X2", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[2] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X2", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[2] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y2", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[2] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y2", DEFAULT_Y_COMPENS,0.9,1.1); 

    sj_cfg_x_offset_11[3] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X3", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[3] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X3", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[3] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y3", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[3] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y3", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[4] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X4", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[4] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X4", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[4] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y4", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[4] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y4", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[5] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X5", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[5] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X5", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[5] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y5", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[5] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y5", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[6] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X6", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[6] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X6", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[6] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y6", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[6] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y6", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[7] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X7", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[7] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X7", DEFAULT_X_COMPENS,0.9,1.1);   
    sj_cfg_y_offset_11[7] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y7", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[7] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y7", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[8] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X8", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[8] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X8", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[8] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y8", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[8] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y8", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[9] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X9", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);   
    sj_cfg_x_compens_11[9] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X9", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[9] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y9", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[9] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y9", DEFAULT_Y_COMPENS,0.9,1.1);

    sj_cfg_x_offset_11[10] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_X10", DEFAULT_X_OFFSET_CALIBRATE,DEFAULT_X_OFFSET_CALIBRATE-5.0,DEFAULT_X_OFFSET_CALIBRATE+5.0);
    sj_cfg_x_compens_11[10] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_X10", DEFAULT_X_COMPENS,0.9,1.1);
    sj_cfg_y_offset_11[10] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisOffset_Y10", DEFAULT_Y_OFFSET_CALIBRATE,DEFAULT_Y_OFFSET_CALIBRATE-5.0,DEFAULT_Y_OFFSET_CALIBRATE+5.0);
    sj_cfg_y_compens_11[10] = new FloatSetting(GRBL, WG, NULL, "SJConfig/AxisCompens_Y10", DEFAULT_Y_COMPENS,0.9,1.1);
